...
[![网易云音乐][netease-music-badge-cn]][netease-music-profile] [![Steam 游戏][steam-games-badge-cn]][steam-profile] [![Steam 好友][steam-friends-badge-cn]][steam-profile] [![联邦宇宙][mastodon-badge-cn]][mastodon-profile] [![电报][telegram-badge-cn]][telegram-profile] [![哔哩哔哩][bilibili-badge-cn]][bilibili-profile] ![QQ][qq-badge-cn]
...
- **编辑器 / IDE**
  - 长用：JetBrains 全家桶 · Zed Editor · Easy Editor
  - 了解：VSCode · NeoVIM
- **语言 / 框架**
  - 长用：Rust · TypeScript · CoffeeScript · Golang
  - 了解：Vue · React · Tauri · Electron · WinUI3 · PyQt
...
- **长期**：我的世界 · Arch Linux · 含街机的各类音乐游戏 · 日系电子音乐及其衍生 V 曲（是 vocaloid 哟！）
- **短期**：Ubuntu Unity 8 · GXDE 15.13 · Pop!_OS COSMIC DE 24.04 · Vue SFC 编写范式 · OOP 学习 · 制作自己的 Arm 架构开发板
...
<div align="center">
<img src="alipay.jpg" width="160" alt="支付宝" />&nbsp;&nbsp;<img src="wechatpay.png" width="160" alt="微信赞赏" />&nbsp;&nbsp;<img src="sponsor.png" width="120" alt="投喂我" />
</div>
...
| [![osu! std][osu-std]][osu] | [![osu! mania][osu-mania]][osu] |
| :-------------------------: | :----------------------------: |

</details>

###### * Thanks Generated By [@hakatashi][hakatashi], [@CAIMEO][caimeo], [Snake Game for Contributions Graph][snk], [OSU! Stats Signature][osu-profile], [GitHub Readme Stats][readme-stats-profile], [Shields][shields-profile] and [Substats][substats-profile].

<div align="right">

[<img alt="Bemly_ | X" width="21" height="21" src="x.png" />][x-profile] [<img alt="Bemly_ | Telegram" height="21" src="tg.png" />][tg-profile]
